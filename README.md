...
## Available Nomenclatures `GET /v1/nomenclatures`
...
## Data Provider Credentials `POST /v1/configuration/dataproviders/:providerId/credentials`
...
## Upload positions `POST /v1/task/positions`
...
## Upload positions without enrichment `POST /v1/task/positions/without-enrichment`)
...
## Task status `GET /v1/task/:taskID/status`
