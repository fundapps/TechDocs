...
function Import-Positions {
    ...
    Import-File -User $User -Password $Password -File $File -Uri ($ClientEnvironment + "-svc.fundapps.co/api/adapptr/v2/task/positions/without-enrichment") -ClientEnvironment $ClientEnvironment
}
