...
```json
{
    ...
    "status": {
        ...
        "description": "Successfully transmitted to Rapptr. Some positions were skipped, most likely due to incomplete data from your market data provider. Please check the warnings field for a list of all skipped positions as well as the cause reason."
    },
...
Those functions created can be used from the command line directly or integrated with other scripts created by client's own teams.
